...
MODEL                = BOOst_mppt
MODULES              = rt_matrx.c rt_printf.c rt_logging_simtarget.c BOOst_mppt.c BOOst_mppt_capi.c BOOst_mppt_data.c BOOst_mppt_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
PRODUCT              = BOOst_mppt.exe
MAKEFILE             = BOOst_mppt.mk
MATLAB_ROOT          = D:/MATLAB/R2022a
ALT_MATLAB_ROOT      = D:/MATLAB/R2022a
START_DIR            = C:/Users/jeffr/Documents/MATLAB/dcdccourse
S_FUNCTIONS_LIB      = $(MATLAB_ROOT)\sys\lcc64\lcc64\lib64\wsock32.lib
NUMST                = 3
NCSTATES             = 3
BUILDARGS            =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="D:\\MATLAB\\R2022a" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 1
ALLOCATIONFCN        = 0
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/BOOst_mppt \
...
rt_matrx.obj : $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c

rt_printf.obj : $(MATLAB_ROOT)/rtw/c/src/rt_printf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/rtw/c/src/rt_printf.c
...
sfun_spid_contc.obj : $(MATLAB_ROOT)/toolbox/physmod/powersys/powersys/sfun_spid_contc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)/toolbox/physmod/powersys/powersys/sfun_spid_contc.c
